class PollData:
    ...
    POLL_MODE_TYPE = {
        ...
        'items': [
            ...
            None,
            {'name': 'Grease Pencil Paint', 'item': 'PAINT_GREASE_PENCIL'},
            {'name': 'Grease Pencil Edit', 'item': 'EDIT_GREASE_PENCIL'},
            {'name': 'Grease Pencil Sculpt', 'item': 'SCULPT_GREASE_PENCIL'},
            {'name': 'Grease Pencil Weight Paint', 'item': 'WEIGHT_GREASE_PENCIL'},
            {'name': 'Grease Pencil Vertex Paint', 'item': 'VERTEX_GREASE_PENCIL'},
            None,
