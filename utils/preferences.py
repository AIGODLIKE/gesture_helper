...
def GestureAddon(AddonPreferences):
    ...
    class Import(bbpy.types.Operator, Data, ImportHelper, File):
        bl_idname = 'ui.custom_ui_import_property'
        bl_label = f'''{bbpy.get.addon.name()} 导入预设'''
    ...
    class Export(bbpy.types.Operator, Data, ExportHelper, File):
        bl_idname = 'ui.custom_ui_export_property'
        bl_label = f'''{bbpy.get.addon.name()} 导出预设'''
