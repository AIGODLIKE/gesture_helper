...
class UiElementItems(PropertyGroup,
    ...
    def change_name(self, name):
        for i in self.ui_element_items:
            i['parent_element_items'] = name

    ui_element_items: PointerProperty(type=UiItem)
