...
from bpy.props import PointerProperty, BoolProperty, FloatProperty, EnumProperty, StringProperty, IntProperty
...
class UiElementItems(PropertyGroup):
    ui_element_items: PointerProperty(type=ElementItem)
